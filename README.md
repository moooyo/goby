...
Progressive video, progressive DeviceProfile coverage in PlaybackInfo, additional audio timing/input profiles, packed-audio HLS, broader subtitle/output formats and events, hard resource isolation, actual GPU execution, and complete third-party-client acceptance remain unfinished. See [build/run instructions](docs/development/running.md), [Universal and progressive audio](docs/development/audio-playback.md), [client playback references](docs/development/client-playback-references.md), [HLS playback](docs/development/hls-playback.md), [transcoding configuration](docs/development/transcoding-configuration.md), [external subtitles](docs/development/external-subtitles.md), [client sessions](docs/development/client-sessions.md), [WebSocket events](docs/development/websocket-events.md), [NextUp behavior and evidence limits](docs/development/next-up.md), and [implementation progress](docs/development/progress.md).

The audio upgrade adds migration `0012` and probe cache version 3. Rescan existing libraries after upgrading so playback uses current source and audio-timing facts; database migrations do not schedule that scan automatically.
