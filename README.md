...
Implementation is underway using PostgreSQL, Go 1.27.1, and FFmpeg 9.0.1. It now includes authentication, a persistent media catalog, safe file probing, bounded scans, library-level access control, initial Emby browsing, and React/MUI user/library/task administration. Artwork, metadata integration and playback work follow, including hardware decoding and encoding. See [build/run instructions](docs/development/running.md), [ingestion verification](docs/development/verification-m2a.md), and [implementation progress](docs/development/progress.md).
