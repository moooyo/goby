...
func TestAudioTimingSupport(t *testing.T) {
	tests := []struct {
		...
		{"ogg_flac", audioTimingTestInfo("ogg", "flac", 48000, "1/48000"), true, ""},
		{"ogg_opus", audioTimingTestInfo("ogg", "opus", 48000, "1/48000"), true, ""},
		{"ogg_vorbis", audioTimingTestInfo("ogg", "vorbis", 44100, "1/44100"), true, ""},
		{"unsupported_format", audioTimingTestInfo("matroska,webm", "flac", 48000, "1/1000"), true, "unsupported_format"},
