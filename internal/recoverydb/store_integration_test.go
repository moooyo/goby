...
func TestRecoveryDatabaseStoreIntegration(t *testing.T) {
	...
	run("reset_preserves_storage_binding_changes", func(t *testing.T) {
	...
	run("reset_preserves_selected_phase1_state_changes", func(t *testing.T) {
		assertRecoverySelectedPhase1ResetProtection(t, f, retained)
	})

	run("reset_preserves_selected_phase2_state_changes", func(t *testing.T) {
		assertRecoverySelectedPhase2ResetProtection(t, f, retained)
	})

	run("reset_preserves_selected_phase3_state_changes", func(t *testing.T) {
		assertRecoverySelectedPhase3ResetProtection(t, f, retained)
	})

	run("reset_preserves_selected_phase4_state_changes", func(t *testing.T) {
		assertRecoverySelectedPhase4ResetProtection(t, f, retained)
	})
