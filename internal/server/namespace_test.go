...
func TestCompatibilityNamespacePreservesIdentifiersAndEncodedNames(t *testing.T) {
	for _, test := range []struct{ path, want string }{
		...
		{"/items/AbC/thumbnailset", "/emby/Items/AbC/ThumbnailSet"},
		{"/EMBY/videos/AbC/INDEX.BIF", "/emby/Videos/AbC/index.bif"},
		{"/items/AbC/images/thumbnail?MediaSourceId=MiXeD", "/emby/Items/AbC/Images/Thumbnail"},
