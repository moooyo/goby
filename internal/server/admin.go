...
func implementedFeatures() map[string]bool {
	return map[string]bool{"UserManagement": true, "SessionManagement": true, "ApplicationKeys": true, "LibraryManagement": true, "MetadataEditing": true, "Playback": true, "Transcoding": false, "HardwareDecoding": false, "HardwareEncoding": false}
}
