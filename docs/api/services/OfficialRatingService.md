...
- [`GET /OfficialRatings`](#operation-getofficialratings)

<a id="operation-getofficialratings"></a>

## GET /OfficialRatings

- Operation ID: `getOfficialratings`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1OfficialRatings/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/OfficialRatingService/getOfficialratings.html).
...
| --- | --- | --- | --- |
| `200` | [QueryResult_UserLibrary.OfficialRatingItem](../models.md#model-queryresult_userlibrary-officialratingitem) | Operation successful. Returning a QueryResult<OfficialRatingItem> object. | `#/paths/~1OfficialRatings/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1OfficialRatings/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1OfficialRatings/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1OfficialRatings/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1OfficialRatings/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1OfficialRatings/get/responses/500` |
