...
Game-specific genre browsing.

**2 HTTP operations**. Service candidate: `DEFERRED`. Status: `planned-unimplemented`.
...
- [`GET /GameGenres`](#operation-getgamegenres)
- [`GET /GameGenres/{Name}`](#operation-getgamegenresbyname)

<a id="operation-getgamegenres"></a>

## GET /GameGenres

- Operation ID: `getGamegenres`.
- Service candidate: `DEFERRED`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1GameGenres/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/GameGenresService/getGamegenres.html).
...
| --- | --- | --- | --- |
| `200` | [QueryResult_BaseItemDto](../models.md#model-queryresult_baseitemdto) | Operation successful. Returning a QueryResult<BaseItemDto> object. | `#/paths/~1GameGenres/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres/get/responses/500` |
...
<a id="operation-getgamegenresbyname"></a>

## GET /GameGenres/{Name}

- Operation ID: `getGamegenresByName`.
- Service candidate: `DEFERRED`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1GameGenres~1{Name}/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/GameGenresService/getGamegenresByName.html).
- Consumes: not declared.
- Produces: `application/json`, `application/xml`.
...
| Status | Schema or reusable response reference | Source description | Source pointer |
| --- | --- | --- | --- |
| `200` | [BaseItemDto](../models.md#model-baseitemdto) | Operation successful. Returning a BaseItemDto object. | `#/paths/~1GameGenres~1{Name}/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres~1{Name}/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres~1{Name}/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres~1{Name}/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres~1{Name}/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1GameGenres~1{Name}/get/responses/500` |
