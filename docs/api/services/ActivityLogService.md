...
- [`GET /System/ActivityLog/Entries`](#operation-getsystemactivitylogentries)

<a id="operation-getsystemactivitylogentries"></a>

## GET /System/ActivityLog/Entries

- Operation ID: `getSystemActivitylogEntries`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1System~1ActivityLog~1Entries/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/ActivityLogService/getSystemActivitylogEntries.html).
...
| `MinDate` | `query` | omitted (Swagger default: false) | string (date-time) | not declared | not declared |
...
| --- | --- | --- | --- |
| `200` | [QueryResult_ActivityLogEntry](../models.md#model-queryresult_activitylogentry) | Operation successful. Returning a QueryResult<ActivityLogEntry> object. | `#/paths/~1System~1ActivityLog~1Entries/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1System~1ActivityLog~1Entries/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1System~1ActivityLog~1Entries/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1System~1ActivityLog~1Entries/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1System~1ActivityLog~1Entries/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1System~1ActivityLog~1Entries/get/responses/500` |
