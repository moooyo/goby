...
- [`GET /MusicGenres`](#operation-getmusicgenres)
- [`GET /MusicGenres/{Name}`](#operation-getmusicgenresbyname)

<a id="operation-getmusicgenres"></a>

## GET /MusicGenres

- Operation ID: `getMusicgenres`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1MusicGenres/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/MusicGenresService/getMusicgenres.html).
...
| --- | --- | --- | --- |
| `200` | [QueryResult_BaseItemDto](../models.md#model-queryresult_baseitemdto) | Operation successful. Returning a QueryResult<BaseItemDto> object. | `#/paths/~1MusicGenres/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres/get/responses/500` |
...
<a id="operation-getmusicgenresbyname"></a>

## GET /MusicGenres/{Name}

- Operation ID: `getMusicgenresByName`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1MusicGenres~1{Name}/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/MusicGenresService/getMusicgenresByName.html).
- Consumes: not declared.
- Produces: `application/json`, `application/xml`.
...
| Status | Schema or reusable response reference | Source description | Source pointer |
| --- | --- | --- | --- |
| `200` | [BaseItemDto](../models.md#model-baseitemdto) | Operation successful. Returning a BaseItemDto object. | `#/paths/~1MusicGenres~1{Name}/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres~1{Name}/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres~1{Name}/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres~1{Name}/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres~1{Name}/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1MusicGenres~1{Name}/get/responses/500` |
