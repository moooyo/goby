...
User library views and grouping.
...
- [`GET /Users/{UserId}/Views`](#operation-getusersbyuseridviews)

<a id="operation-getusersbyuseridviews"></a>

## GET /Users/{UserId}/Views

- Operation ID: `getUsersByUseridViews`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1Users~1{UserId}~1Views/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/UserViewsService/getUsersByUseridViews.html).
...
| `IncludeExternalContent` | `query` | true | boolean | not declared | not declared |
...
| --- | --- | --- | --- |
| `200` | [QueryResult_BaseItemDto](../models.md#model-queryresult_baseitemdto) | Operation successful. Returning a QueryResult<BaseItemDto> object. | `#/paths/~1Users~1{UserId}~1Views/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Views/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Views/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Views/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Views/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Views/get/responses/500` |
