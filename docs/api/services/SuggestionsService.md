...
- [`GET /Users/{UserId}/Suggestions`](#operation-getusersbyuseridsuggestions)

<a id="operation-getusersbyuseridsuggestions"></a>

## GET /Users/{UserId}/Suggestions

- Operation ID: `getUsersByUseridSuggestions`.
- Service candidate: `EXPANSION`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1Users~1{UserId}~1Suggestions/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/SuggestionsService/getUsersByUseridSuggestions.html).
...
| --- | --- | --- | --- |
| `200` | [QueryResult_BaseItemDto](../models.md#model-queryresult_baseitemdto) | Operation successful. Returning a QueryResult<BaseItemDto> object. | `#/paths/~1Users~1{UserId}~1Suggestions/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Suggestions/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Suggestions/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Suggestions/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Suggestions/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Suggestions/get/responses/500` |
