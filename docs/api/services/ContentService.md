...
User home sections and section item queries.
...
- [`GET /Users/{UserId}/HomeSections`](#operation-getusersbyuseridhomesections)
- [`GET /Users/{UserId}/Sections/{SectionId}/Items`](#operation-getusersbyuseridsectionsbysectioniditems)

<a id="operation-getusersbyuseridhomesections"></a>

## GET /Users/{UserId}/HomeSections

- Operation ID: `getUsersByUseridHomesections`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1Users~1{UserId}~1HomeSections/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/ContentService/getUsersByUseridHomesections.html).
...
| --- | --- | --- | --- |
| `200` | array&lt;[ContentSection](../models.md#model-contentsection)&gt; | Operation successful. Returning a List<ContentSection> object. | `#/paths/~1Users~1{UserId}~1HomeSections/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1HomeSections/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1HomeSections/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1HomeSections/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1HomeSections/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1HomeSections/get/responses/500` |
...
<a id="operation-getusersbyuseridsectionsbysectioniditems"></a>

## GET /Users/{UserId}/Sections/{SectionId}/Items

- Operation ID: `getUsersByUseridSectionsBySectionidItems`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1Users~1{UserId}~1Sections~1{SectionId}~1Items/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/ContentService/getUsersByUseridSectionsBySectionidItems.html).
- Consumes: not declared.
- Produces: `application/json`, `application/xml`.
...
| Name | In | Required declaration | Type or schema | Default / enum | Other constraints |
| --- | --- | --- | --- | --- | --- |
| `SectionId` | `path` | true | string | not declared | not declared |
...
| Status | Schema or reusable response reference | Source description | Source pointer |
| --- | --- | --- | --- |
| `200` | [QueryResult_BaseItemDto](../models.md#model-queryresult_baseitemdto) | Operation successful. Returning a QueryResult<BaseItemDto> object. | `#/paths/~1Users~1{UserId}~1Sections~1{SectionId}~1Items/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Sections~1{SectionId}~1Items/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Sections~1{SectionId}~1Items/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Sections~1{SectionId}~1Items/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Sections~1{SectionId}~1Items/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Users~1{UserId}~1Sections~1{SectionId}~1Items/get/responses/500` |
