...
- [`GET /Movies/Recommendations`](#operation-getmoviesrecommendations)

<a id="operation-getmoviesrecommendations"></a>

## GET /Movies/Recommendations

- Operation ID: `getMoviesRecommendations`.
- Service candidate: `CORE-CANDIDATE`; status: `planned-unimplemented`.
- Source pointer: `#/paths/~1Movies~1Recommendations/get`.
- [Derived official reference](https://dev.emby.media/reference/RestAPI/MoviesService/getMoviesRecommendations.html).
...
| --- | --- | --- | --- | --- | --- |
| `CategoryLimit` | `query` | omitted (Swagger default: false) | integer (int32) | not declared | not declared |
| `ItemLimit` | `query` | omitted (Swagger default: false) | integer (int32) | not declared | not declared |
...
| --- | --- | --- | --- |
| `200` | array&lt;[RecommendationDto](../models.md#model-recommendationdto)&gt; | Operation successful. Returning a RecommendationDto[] object. | `#/paths/~1Movies~1Recommendations/get/responses/200` |
| `400` | [#/responses/400](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Movies~1Recommendations/get/responses/400` |
| `401` | [#/responses/401](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Movies~1Recommendations/get/responses/401` |
| `403` | [#/responses/403](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Movies~1Recommendations/get/responses/403` |
| `404` | [#/responses/404](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Movies~1Recommendations/get/responses/404` |
| `500` | [#/responses/500](../../sources/emby-sdk-openapi.snapshot.json) | not declared | `#/paths/~1Movies~1Recommendations/get/responses/500` |
