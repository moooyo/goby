...
| `codex/m5-media-diagnostics`, `3d53f71` | [Diagnostic execution layers](https://github.com/moooyo/goby/blob/3d53f7108fa7abf0815b9b42b4fbc6c0e23fb22a/docs/development/media-diagnostics.md): fixed YUV420P/PCM samples and closed plans plus an internal Linux process session, pre-exec cgroup limits, immutable input descriptors and fixed-reference content checks. The prior twelve and new eighteen cases remain unexecuted; static review and remote formatting complete | Connect stage orchestration/preparation records, actual codec/hardware evidence, deployment prerequisites, administrator/conversion admission, cancellation/result retention, API and Settings UI. Calibrate content thresholds and verify software/available hardware profiles. No resource/media execution, API/UI or M5 acceptance is claimed |
