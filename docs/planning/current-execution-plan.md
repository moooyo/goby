...
bindings. The verified operator revision is published under the existing contract
version; complete actual entry/admission without a framework, launcher or
