...
| 3. Concurrency and recovery | Core staging/spool/paging/configuration/resource and fixture/runtime/oracle/overload sources integrated | Pending admission; dedicated guest/dependencies ready, product runs not started | Pending |
