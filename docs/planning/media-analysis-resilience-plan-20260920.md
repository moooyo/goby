...
| 2. Intro analysis and BIF previews | Shared lifecycle, preview delivery and management implemented; source `49acf4d` fixes recursive projection loss | Four new builds and 99 intro tests passed; with 337 unchanged old scopes, 436 parent observations are retained. Calibration now preserves six safe candidates but still qualifies only three originals; one group has 848/1000 matched visual time against the unchanged 850/1000 gate. Controlled acceptance, sealed holdout and real consumers remain open. | Pending |
