...
| 3. Concurrency and recovery | Core sources integrated; observed concurrency lock inversion repaired at `5fb968a` | Repair regression/builds accepted with explicit skips. Failed 10k evidence is retained; a later preparation-tool mismatch is corrected and a fresh runtime is provisioned. Complete capacity journeys and fault/reboot acceptance remain pending | Pending |
