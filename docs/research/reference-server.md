...
[metadata updates and locks](metadata-reference.md) and [application keys](api-key-reference.md), [key playback](api-key-playback-reference.md), [client contexts](api-key-context-reference.md), and [target scope](api-key-scope-reference.md). The retained corpus now
contains 1128 JSON records, including supporting observations and
