...
6. Define native settings concurrency, final-administrator protection, token revocation, restore identity handling, media deletion safeguards, and unavailable-mount policy before exposing mutations.
