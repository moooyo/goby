...
complete-profile consumers incorrectly require `verified`. A correction is
prepared in the separate Programs worktree, but is not tested or integrated.
...
there is no new v4 epoch or client acceptance.
