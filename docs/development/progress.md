...
| M0 core reference capture | Baseline complete; broader coverage pending | Official Emby 4.9.5.0 isolated on test-env, 610 audited HTTP/WebSocket/media records, including HLS and Universal/progressive audio positives and preserved failures; global NextUp selection remains unresolved; [HTTP report](../research/reference-server.md), [WebSocket report](../research/websocket-reference.md), [HLS report](../research/hls-reference.md), [audio report](../research/audio-reference.md) |
...
| M4 conversion and hardware pipeline | Engine, HLS VOD and Universal/progressive audio increments complete; milestone incomplete | [M4a](verification-m4a-engine.md) and [M4b](verification-m4b-hls.md) established conversion and full VOD. [M4c](verification-m4c-audio.md) adds scoped client references, schema 12, probe version 3 exact audio timing, progressive outputs and audio HLS tail handling; complete Linux race tests, deployed audio acceptance and existing-library rescan passed. Progressive PlaybackInfo profiles/video, additional tracks/formats, hard resource controls, actual GPU decode/encode and full client acceptance remain |
