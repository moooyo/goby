...
| M0 core reference capture | Baseline complete; broader coverage pending | Official Emby 4.9.5.0 isolated on test-env, 342 audited HTTP/WebSocket records, including subtitle timing/conversion, token-scoped events and remote-control captures; global NextUp selection remains unresolved; [HTTP report](../research/reference-server.md), [WebSocket report](../research/websocket-reference.md) |
