...
| M0 core reference capture | Baseline complete; broader coverage pending | Official Emby 4.9.5.0 isolated on test-env, 736 audited records including HTTP/WebSocket/media observations; HLS, Universal/progressive audio and ordered audio profiles include measured positives and preserved failures. Global NextUp selection remains unresolved; [HTTP report](../research/reference-server.md), [WebSocket report](../research/websocket-reference.md), [HLS report](../research/hls-reference.md), [audio report](../research/audio-reference.md), [audio profile report](../research/audio-profile-reference.md) |
...
| M4 conversion and hardware pipeline | Engine, HLS VOD, Universal/progressive audio and audio profile increments complete; milestone incomplete | [M4a](verification-m4a-engine.md) and [M4b](verification-m4b-hls.md) established conversion and full VOD. [M4c](verification-m4c-audio.md) adds scoped client references, schema 12, exact audio timing and progressive outputs. [M4d](verification-m4d-audio-profiles.md) adds ordered PlaybackInfo audio profiles, projected output constraints, probe version 4 Ogg timing and sample-based Ogg seeking; complete Linux race tests, deployed profile workflows and all five existing-library upgrades passed. Progressive video, additional tracks/formats, hard resource controls, actual GPU decode/encode and full client acceptance remain |
