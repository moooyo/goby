...
| M4 conversion and hardware pipeline | Engine increment complete; milestone incomplete | [M4a verification](verification-m4a-engine.md): real remux/audio/video conversion through planner, PostgreSQL, manager and decoder; Linux full race suite and unprivileged execution passed. Full VOD/HLS HTTP graph, seek scheduling, transcode policies/configuration, additional tracks/formats, hard resource controls and actual GPU decode/encode remain |
