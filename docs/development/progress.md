...
| M0 core reference capture | Baseline complete; broader coverage pending | Official Emby 4.9.5.0 isolated on test-env, 317 audited HTTP/WebSocket records, including subtitle timing/conversion and token-scoped socket events; global NextUp selection remains unresolved; [HTTP report](../research/reference-server.md), [WebSocket report](../research/websocket-reference.md) |
...
| M3 initial client playback | Original playback/state, client sessions/NextUp, and external SRT/WebVTT increments complete; milestone incomplete | Full Linux race tests and deployed media/subtitle workflows passed; [M3a](verification-m3a-original-playback.md), [M3b](verification-m3b-sessions-nextup.md), [M3c](verification-m3c-subtitles.md). Events, broader subtitle handling, global NextUp parity and real-client acceptance remain |
