...
A new 34-request complete baseline observer is required before fresh preparation.
SSH is available. The transport live CLI remains disabled pending an attested
real fixture and reviewed outer operator; actual matrix/client acceptance is open.
