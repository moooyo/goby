...
$catalog.Add('')
$catalog.Add('All entries are source-derived and **planned, unimplemented**. Listing a route does not mean')
$catalog.Add('that its behavior has been implemented, tested, or shown compatible with a real client.')
$catalog.Add('')
