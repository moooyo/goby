...
export async function runCrossUserGuards(source) {
  ...
  const source55Scope = 'library-changed-ui-source55-v7';
  test('source55_catalog_scope_is_explicit_and_does_not_expand_source44', () => {
    ...
    rejected(() => api.libraryChangedCatalogRequest(ORIGIN + `/Items/${changedLibrary}`, 'GET', changedUser, 'library-changed-ui-source55-v8'));
  });
  test('source55_keeps_existing_websocket_budgets_and_wire_delivery', async () => {
    ...
    rejected(() => api.websocketHandshakeBudget('library-changed-ui-source55-v6'));
    rejected(() => api.websocketLifetimeBudget('library-changed-ui-source55-v6'));
