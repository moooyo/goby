#!/usr/bin/env python3
"""Dispose only the independently reviewed, empty source22 Theme test pair.
...
RUN = "20260911_100529_3644bd3c133a"
WORK = Path("/opt/goby-test/exec-work-m3e")
SOURCE = WORK / "source-attempt-22"
...
MANIFEST_SHA = "a310305aebe670ca8e613943f64b83386bcf41d64afa9befbb2d37a4d9bf0238"
RECEIPT_SHA = "0f46e096ccefff2ef1c6a7f18fff95934279ba0ddb99507dd0ff579e2285ffcf"
REPORT_SHA = "267d301682b77386d4b9c90fc22e180278f7bcb59095199b42ab432a882e4e76"
LOG_SHA = "f8c81cbd57b6633799ca645855f872a9fe5ed8afc0db0221933ad1b81f351c37"
...
PAIRS = [{"name": "goby_backup_m3e_source", "role_oid": 5098260, "database_oid": 5098261},
         {"name": "goby_backup_m3e_target", "role_oid": 5098262, "database_oid": 5098263}]
OUTPUT_IDENTITY = {"device": 2049, "inode": 3152507}
...
def load_runner():
    ...
    if not stat.S_ISREG(info.st_mode) or info.st_nlink != 1 or hashlib.sha256(RUNNER.read_bytes()).hexdigest() != RUNNER_SHA:
        raise RuntimeError("The pinned runner differs from the reviewed source22 input.")
    spec = importlib.util.spec_from_file_location("source22_disposal_runner", RUNNER)
