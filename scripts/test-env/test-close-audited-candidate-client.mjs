...
async function main() {
  ...
  assert(args.length === 4 && args[0] === '--source' && args[2] === '--output', 'arguments_required');
  ...
  const report = { kind: 'audited-candidate-client-closeout-pure-guards', version: 1,
    scope: 'Exported pure functions on synthetic fixtures only; no end-to-end or client acceptance claim.',
  ...
  if (tests.length !== 12 || report.failed || !unchanged) process.exitCode = 1;
}
